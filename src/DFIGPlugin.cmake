set(DFIGPLUGIN_NAME dfigPlugin)

file(GLOB DFIGPLUGIN_CPP_SOURCES  ${CMAKE_CURRENT_LIST_DIR}/*.cpp)
file(GLOB DFIGPLUGIN_CPP_INCS     ${CMAKE_CURRENT_LIST_DIR}/*.h)
...
# Build as a shared library (DLL / .so / .dylib)
add_library(${DFIGPLUGIN_NAME} SHARED ${DFIGPLUGIN_CPP_SOURCES} ${DFIGPLUGIN_INC_GUI} ${DFIGPLUGIN_CPP_INCS}
...
# IDE source groups
source_group("inc\\inc"     FILES ${DFIGPLUGIN_CPP_INCS})
...
source_group("src\\cpp"     FILES ${DFIGPLUGIN_CPP_SOURCES})

# Link against natID libraries
...
# Define PLUGIN_EXPORTS so the DLL export macros activate
